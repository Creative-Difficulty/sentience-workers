...
All three services are dockerized. The easiest way to run/deploy all of them is to use docker compose (`docker compose up -d`, -d for `detached`, running in the background).
